...
class Api {
  ...
  static Wenku8Node get wenku8Node =>
      LocalStorageService.instance.getWenku8Node();

  /// 根据排名获取小说列表
  /// - [ranking] 排行榜种类
  /// - [index] 第几页
  static Future<Resource> getNovelByRanking({
  ...
  static Future<Resource> addNovel({required String aid}) {
    final String url =
        "${wenku8Node.node}/modules/article/addbookcase.php?bid=$aid";
    return Request.get(url, charsetsType: charsetsType);
  }
  ...
  static Future<Resource> removeNovel({required String delid}) {
    final String url =
        "${wenku8Node.node}/modules/article/bookcase.php?delid=$delid";
    return Request.get(url, charsetsType: charsetsType);
  }
  ...
  static Future<Resource> removeNovelFromList({
  ...
  static Future<Resource> moveNovelToOther({
    required List<String> list,
    required int classId,
  ...
  static Future<Resource> getBookshelf({required int classId}) {
    final String url =
        "${wenku8Node.node}/modules/article/bookcase.php?classid=$classId";
    return Request.get(url, charsetsType: charsetsType);
  }
  ...
  /// - [aid] 该评论区所属的书籍的id
  /// - [index] 第几页
  static Future<Resource> getComment({
    required String aid,
    required int index,
  }) {
    final String url =
        "${wenku8Node.node}/modules/article/reviews.php?aid=$aid&page=$index";
    return Request.get(url, charsetsType: charsetsType);
  }
  ...
  static Future<Resource> getReply({required String rid, required int index}) {
    final String url =
        "${wenku8Node.node}/modules/article/reviewshow.php?rid=$rid&page=$index";
    return Request.get(url, charsetsType: charsetsType);
  }
  ...
  static Future<Resource> novelVote({required String aid}) {
    final String url =
        "${wenku8Node.node}/modules/article/uservote.php?id=$aid";
    return Request.get(url, charsetsType: charsetsType);
  }
  ...
  /// - [title] 标题关键字
  /// - [index] 第几页
  static Future<Resource> searchNovelByTitle({
    ...
    final String url =
        "${wenku8Node.node}/modules/article/search.php?searchtype=articlename&searchkey=$title&page=$index";
    return Request.get(url, charsetsType: charsetsType);
  }
  ...
  /// - [author] 作者关键字
  /// - [index] 第几页
  static Future<Resource> searchNovelByAuthor({
    ...
    final String url =
        "${wenku8Node.node}/modules/article/search.php?searchtype=author&searchkey=$author&page=$index";
    return Request.get(url, charsetsType: charsetsType);
  }
  ...
  /// - [title] 书评的标题
  /// - [content] 书评的内容
  static Future<Resource> sendComment({
    required String aid,
    required String title,
    required String content,
  }) {
    final String url =
        "${wenku8Node.node}/modules/article/reviews.php?aid=$aid";
  ...
  /// - [rid] 要回复的书评id
  /// - [content] 回复的内容
  static Future<Resource> sendReply({
    required String aid,
    required String rid,
    required String content,
  }) {
    final String url =
        "${wenku8Node.node}/modules/article/reviewshow.php?rid=$rid&aid=$aid";
